                    ...
                    <div class="card card-details">
                                 ...
                                 <tr>
                                    ...
                                    <td class="align-middle">
                                        <a href="{{ route('checkout-remove', $detail->id) }}">
                                            <img src="{{ url ('/frontend/image/icon remove.png') }}" alt="">
                                        </a>
                                    </td>
                                </tr>
                                 @empty
                     ...
                     <div class="member mt-3">
                         ...
                         <p class="disclaimer mb-0">
                             You are only able to invite member that has registered in Jalanin.
                         </p>
                     </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="card card-details card-right">
                        ...
                        <table class="trip-informations">
                         ...
                         <tr>
                             <th width="50%">Total Payment<br>(+Unique Code)</th>
                        ...
                        <div class="bank">
                            <div class="bank-item pb-3">
                                <img src="{{ url ('frontend/image/icon Bank.png') }}" alt="" class="bank-image">
